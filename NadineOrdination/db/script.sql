create table KRANKHEIT (k_id integer not null auto_increment, 
						beschreibung varchar(300), 
						primary key(k_id));
create table PATIENT (p_id integer not null auto_increment, 
					vname varchar(100), nname varchar(100), 
					adresse varchar(200), 
					gebDatum datetime, 
					telnr varchar(100), 
					tarif double, 
					primary key(p_id));
create table BEHANDLUNG (b_id integer not null auto_increment, 
						p_id integer not null, 
						datum datetime, 
						beh_beschreibung varchar(300), 
						einnahme double, 
