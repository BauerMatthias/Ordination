 ...
 * Time: 15:03
 */
public class DateAxis extends Axis<LocalDateTime> {
    ...
    public DateAxis(final boolean AUTO_RANGING) {
        this("", LocalDateTime.now(), LocalDateTime.now().plusHours(1), AUTO_RANGING);
    }
    public DateAxis(final LocalDateTime LOWER_BOUND, final LocalDateTime UPPER_BOUND) {
        this("", LOWER_BOUND, UPPER_BOUND, true);
    }
    public DateAxis(final LocalDateTime LOWER_BOUND, final LocalDateTime UPPER_BOUND, final boolean AUTO_RANGING) {
        this("", LOWER_BOUND, UPPER_BOUND, AUTO_RANGING);
    }
    public DateAxis(final String AXIS_LABEL, final LocalDateTime LOWER_BOUND, final LocalDateTime UPPER_BOUND, final boolean AUTO_RANGING) {
        super();
